...
export const searchSong = async (query) => {
  ...
  // Parse the query to extract track and artist
  const queryParams = new URLSearchParams(query);
  const trackName = queryParams.get('track');
  ...
  // Double encode the query
  const encodedQuery = encodeURIComponent(encodeURIComponent(spotifyQuery));
